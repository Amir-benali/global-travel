...
import com.globalTravel.models.car.*;
...
import com.globalTravel.services.car.*;
...
import java.util.Date;
        ...
        public class Main {
            public static void main(String[] args) {
                ...
                CarReservationService carReservationService = new CarReservationService();
                ;
                System.out.println(carReservationService.rechercher());
